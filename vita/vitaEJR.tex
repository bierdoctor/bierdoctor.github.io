...
\textbf{Rader, E.} (in press). Examining User Surprise as a Symptom of Algorithmic Filtering. \emph{International Journal of Human Computer Studies}, doi: 10.1016/j.ijhcs.2016.10.005
...
%
%\textbf{Rader, E.} and Slaker, J. ``It Goes In Steps'': User Beliefs about What an Activity Tracker Knows.
%
%Pak, C.K., \textbf{Rader, E.}, and Hong, S.J. A simulation study to investigate the effect of rank on information diversity on Facebook
%
%Wash, R. and \textbf{Rader, E.}. Can People Self-Report Security Accurately? Agreement Between Self-Report and Behavioral Measures
...
\vspace{1pt}
\begin{tabbing}
2016 \hspace{0.3in}\=  Member of the Media and Information Dept. PhD Committee \\ % Spring
