...
Wash, R., \textbf{Rader, E.}, Berman, R., and Wellmer, Z. (in press) Understanding Password Choices: How Frequently Entered Passwords are Re-used Across Websites. \emph{SOUPS 2016}. Acceptance rate 28\%.
...
2016 \hspace{0.3in}\=  \emph{MIS PhD 2016 Research Seminar Series} Topic: How the Facebook News Feed Algorithm \\
...
\begin{tabbing}
2016 \hspace{0.3in}\=  Media and Information Dept. PhD Committee (Spring) \\\\
...
Soo Jeong Hong, MIS PhD (prelim) \\
Wenjuan Ma, MIS PhD (dissertation) \\
Janine Slaker, MIS PhD (prelim) \\
Jacob Solomon, MIS PhD (dissertation)
